...
- https://docs.microsoft.com/azure/cost-management-billing/manage/create-subscription
- https://docs.microsoft.com/azure/cost-management-billing/manage/switch-azure-offer
- https://learn.microsoft.com/azure/cloud-adoption-framework/ready/landing-zone/design-area/resource-org-subscriptions
- https://learn.microsoft.com/azure/cloud-adoption-framework/ready/azure-best-practices/organize-subscriptions
...
- https://learn.microsoft.com/training/modules/use-azure-resource-manager/
- https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits

## Management Groups
- https://docs.microsoft.com/azure/governance/management-groups/create
- https://docs.microsoft.com/azure/governance/management-groups/manage

## Resource Tags:
- https://docs.microsoft.com/azure/cloud-adoption-framework/decision-guides/resource-tagging

## Resource use charges
- https://docs.microsoft.com/azure/billing/billing-understand-your-invoice
...
# Azure RBAC
- https://docs.microsoft.com/azure/role-based-access-control/role-definitions-list
- https://docs.microsoft.com/learn/modules/create-custom-azure-roles-with-rbac/
- https://docs.microsoft.com/azure/role-based-access-control/role-assignments-portal
- https://docs.microsoft.com/learn/modules/manage-subscription-access-azure-rbac/3-elevate-your-access-user-access-admin
- https://docs.microsoft.com/azure/role-based-access-control/quickstart-assign-role-user-portal
- https://docs.microsoft.com/azure/role-based-access-control/check-access
